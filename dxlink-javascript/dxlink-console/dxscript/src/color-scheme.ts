 ...
 * reading the MUI palette — here, the dxScript editor. `useTheme().palette.mode`
 ...
 *
 * Deliberately duplicated in each channel package that needs it rather than hoisted into
 * core: a plugin package is self-contained, and core holds nothing that exists only to serve
 * a channel.
 */
